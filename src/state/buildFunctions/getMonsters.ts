import {
  destroyAllSupportedCards,
  destroyMadness,
  eachPlayerDiscardsTopCardsOfDeck,
  eachPlayerGetsMadnessIntoHand,
  eachPlayerGetsMadnessIntoSupport,
  eachPlayerWithMadnessGetsMadnessIntoHand,
} from "../gameFunctions/abilities";
...
export function getMonsters(): IMonster[] {
  return [
    {
      abilityFunction: (callback) => eachPlayerDiscardsTopCardsOfDeck(2, callback),
    ...
    // },
    {
      abilityFunction: (callback) => eachPlayerGetsMadnessIntoSupport(callback),
    ...
    {
      abilityFunction: (callback) => destroyMadness(game.players.length, callback),
    ...
    {
      abilityFunction: (callback) => eachPlayerGetsMadnessIntoHand(callback),
    ...
    // },
    {
      abilityFunction: (callback) => destroyAllSupportedCards(callback),
    ...
    {
      abilityFunction: (callback) => eachPlayerWithMadnessGetsMadnessIntoHand(callback),
    ...
    // },
    {
      abilityFunction: (callback) => callback(),
